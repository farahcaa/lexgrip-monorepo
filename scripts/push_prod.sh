...
for service in app-platform; do
    overlay_path="services/$service/k8s/overlays/prod"
...
echo "Generating prod manifests..."
bazel build //k8s:manifests --//build_flags:pipeline=prod

echo "Prod images pushed and manifests generated!"
