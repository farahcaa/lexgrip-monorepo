...
for service in app-platform; do
    overlay_path="services/$service/k8s/overlays/staging"
...
bazel build //k8s:manifests --//build_flags:pipeline=staging

echo "Staging images pushed and manifests generated!"
